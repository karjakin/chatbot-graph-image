...
json_file_path = 'background-uno2.json'
...
def json_imagen(img_path,prompt, id, neg_prompts):
    ...
    data["4"]["inputs"]["image"] = img_path["1"]
...
def fondo_uno(img_path,prompt, id, neg_prompts,directory_path,limite,json_output_path):
...
if __name__ == "__main__" :
    ...
    limite= 1
    fondo_uno(img_path,prompt, id, neg_prompts,directory_path,limite,json_output_path)
