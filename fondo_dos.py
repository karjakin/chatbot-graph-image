...
json_file_path = 'background-dos.json'
...
def json_imagen(img_path,prompt, id, neg_prompts):
    ...
    data["165"]["inputs"]["image"] = img_path["2"]
...
def fondo_dos(img_path,prompt, id, neg_prompts,directory_path,limite,json_output_path):
...
if __name__ == "__main__" :
    ...
    limite= 1
    fondo_dos(img_path,prompt, id, neg_prompts,directory_path,limite,json_output_path)
