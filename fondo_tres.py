...
json_file_path = 'background-tres.json'
...
def fondo_tres(img_path,prompt, id, neg_prompts,directory_path,limite,json_output_path):
...
if __name__ == "__main__" :
    ...
    limite= 1
    fondo_tres(img_path,prompt, id, neg_prompts,directory_path,limite,json_output_path)
